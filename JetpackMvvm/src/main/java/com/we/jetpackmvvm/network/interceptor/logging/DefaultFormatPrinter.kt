package com.we.jetpackmvvm.network.interceptor.logging

import android.text.TextUtils
import com.we.jetpackmvvm.network.interceptor.logging.LogInterceptor.Companion.isJson
import com.we.jetpackmvvm.network.interceptor.logging.LogInterceptor.Companion.isXml
import com.we.jetpackmvvm.util.CharacterHandler.Companion.jsonFormat
import com.we.jetpackmvvm.util.CharacterHandler.Companion.xmlFormat
import com.we.jetpackmvvm.util.LogUtilsNet
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    override fun printJsonRequest(
        ...
        val tag = getTag(true)
        LogUtilsNet.debugInfo(tag, REQUEST_UP_LINE)
        logLines(
            tag,
        ...
        LogUtilsNet.debugInfo(tag, END_LINE)
    }
    ...
    override fun printJsonResponse(
        ...
        LogUtilsNet.debugInfo(tag, RESPONSE_UP_LINE)
