 ...
 */
@Module
public class WeChatNumberModule {
    private WeChatNumberContract.View view;
     ...
     * @param view
     */
    public WeChatNumberModule(WeChatNumberContract.View view) {
        this.view = view;
    }

    @FragmentScope
    @Provides
    WeChatNumberContract.View provideSystemView() {
        return this.view;
    }

    @FragmentScope
    @Provides
    WeChatNumberContract.Model provideSystemModel(WeChatNumberModel model) {
        return model;
    }
    ...
    @FragmentScope
    @Provides
    ArrayList<RecyclerViewFragment> provideFragmentList() {
        return new ArrayList<>();
    }
