...
import test.juyoufuli.com.myapplication.databinding.FragmentHomeBinding
 ...
 * Description:
 */
class HomeFragment : BaseFragment<FragmentHomeBinding>(), OnRefreshListener, OnLoadMoreListener {
    ...
    override fun attachBinding(): FragmentHomeBinding {
        return FragmentHomeBinding.inflate(LayoutInflater.from(requireContext()))
    }
