 ...
 */
@FragmentScope
@Component(modules = WeChatNumberModule.class, dependencies = AppComponent.class)
public interface WeChatNumberComponent {

    void inject(WeChatNumberFragment fragment);
}
